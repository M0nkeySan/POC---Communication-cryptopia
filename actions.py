...
def buy_order(api, pair):
    ...
    if disponibilite_achat != 0:
        ...
        while not correct:
            try:
                balance_utilisee = float(
                    raw_input("Combien de {} voulez-vous utiliser ? : ".format(libelles_coin[1])))
                correct = True
            except ValueError:
        ...
        while not correct:
            try:
                bid_price = float(raw_input("Quel est votre prix ? : "))
                correct = True
            except ValueError:
                print 'Veuillez entrer un nombre !'
        ...
        print "\n[+] Ordre d'achat placé pour {:.8f} {} coins à {:.8f} {} \
               chacun pour un total de {} {}".format(num_coins, libelles_coin[0], bid_price, libelles_coin[1], prix_achat, libelles_coin[1])
...
def sell_order(api, pair):
    ...
    if disponibilite_vente == 0:
        ...
        while not correct:
            try:
                balance_utilisee = float(
                    raw_input("Combien de {} voulez-vous utiliser ? : ".format(libelles_coin[0])))
                correct = True
            except ValueError:
                print 'Veuillez entrer un nombre !'
        ...
        while not correct:
            try:
                ask_price = float(raw_input("Quel est votre prix ? : "))
                correct = True
            except ValueError:
                print 'Veuillez entrer un nombre !'
        ...
        print "\n[+] Ordre de vente placé pour {:.8f} {} coins à {:.8f} {} \
               chacun pour un total de {} {}".format(num_coins, libelles_coin[0], ask_price, libelles_coin[1], prix_vente, libelles_coin[1])
